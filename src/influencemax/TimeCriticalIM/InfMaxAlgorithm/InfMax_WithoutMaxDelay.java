 ...
 * 贪心的对比算法，考虑用户在线时间，不考虑最大传播时延，可以看作是传统的影响最大化算法
 */
public class InfMax_WithoutMaxDelay implements InfMaxInterface {
    ...
    public static void main(String[] args){
        //假设1小时
        InfMax_WithoutMaxDelay test = new InfMax_WithoutMaxDelay(36400, 3600, 1.0/ 320.0, "");
    ...
    public InfMax_WithoutMaxDelay(double startTime, double maxDelay, double theta, String tableNameSuffix){
    ...
    public List<UserInfluence> calcInitialInfluence(){
        ...
        try{
            ...
            InfluenceMaxUtilMethod.fetchSingleDelayMap(m_onlineUserSet, st, tmpSingleDelayMap, m_singleInfMap, tmpDelayMap , m_infMap, m_tableNameSuffix);
